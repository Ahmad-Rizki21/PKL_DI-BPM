                ...
                if(mysqli_stmt_num_rows($stmt) == 1){   
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        ...
                        if(password_verify($password, $hashed_password)){
                            ...
                            $login_err = "Password antum salah masyaallah.";
                        }
                    }
                } else {
                    // Menampilkan error jika nama atau password tidak sesuai
                    $login_err = "Nama atau password antum tidak sesuai.";
                }
            } else {
                echo "Ini Error Ngabs, coba lagi aja nanti!";
            }
...
<body>
    <div class="wrapper">
        <h2>Login</h2>
        <p>Assalamualaikum, antum silahkan login di bawah dlu baru bisa masuk mweheheh</p>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Antum tidak memiliki akun? <a href="register.php">Daftar disini!</a>.</p>
        </form>
    </div>
</body>
</html>